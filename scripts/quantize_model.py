...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Quantize a model and emit a report")
...
def main() -> None:
    ...
    _, logger = prepare_runtime(log_name=f"quantize_{quant_config['run_name']}", debug=args.debug, seed=seed)
    ...
    logger.info("Quantization complete: %s", result)
